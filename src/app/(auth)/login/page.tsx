  ...
  loading: () => (
    <div className="flex min-h-screen items-center justify-center bg-gray-950 p-4">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 overflow-hidden rounded-lg border border-green-700/50 bg-zinc-900 shadow-xl shadow-green-500/20">
        <Skeleton className="hidden md:block h-[500px] w-full rounded-l-lg bg-gray-800" />
        <div className="space-y-6 rounded-lg md:rounded-l-none bg-zinc-900 p-8">
            <div className="space-y-2 text-center">
                <Skeleton className="mx-auto h-12 w-48 bg-gray-700" />
                <Skeleton className="mx-auto h-6 w-32 bg-gray-700" />
            ...
            <div className="space-y-4">
                ...
                <Skeleton className="mx-auto h-4 w-40 bg-gray-800" />
            </div>
        </div>
      </div>
    </div>
